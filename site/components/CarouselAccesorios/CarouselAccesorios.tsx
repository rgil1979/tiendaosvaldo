...
import styles from "./CarouselAccesorios.module.css"

interface CarouselAccesoriosProps {
  products: MLProductFull[]
  itemsPerView?: 4 | 3 | 2 | 1
  scrollStep?: number
}

export default function CarouselAccesorios({ products, itemsPerView = 4, scrollStep = 2 }: CarouselAccesoriosProps) {
