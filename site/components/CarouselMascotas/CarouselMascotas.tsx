...
import styles from "./CarouselMascotas.module.css"

interface CarouselMascotasProps {
  products: MLProductFull[]
  itemsPerView?: 4 | 3 | 2 | 1
  scrollStep?: number
}

export default function CarouselMascotas({ products, itemsPerView = 4, scrollStep = 2 }: CarouselMascotasProps) {
